<template>
  <div
    class="demo-banner py-3 text-white text-center fw-bold theme-bg-secondary text-white"
  >
    Love this template? Need more page designs?
    <a
      class="btn font-weight-bold ms-2 theme-btn-on-bg mt-2 mt-md-0"
      href="https://themes.3rdwavemedia.com/bootstrap-templates/mobile/bootstrap-template-for-mobile-apps-nova-pro/"
      target="_blank"
      ><i class="fas fa-external-link-alt me-2"></i>Check out
      <span class="text-uppercase">Nova Pro</span></a
    >
  </div>
  <header class="header">
    <div class="branding">
          ...
          <h1 class="site-logo">
            <a class="navbar-brand" href="/"
              ...
              <span class="logo-text"
                >NOVA <span class="alt rounded">Pro</span></span
              ></a
            >
          </h1>
      ...
      <div class="row figure-holder">
        <div class="col-12 col-md-6 pt-3 pt-md-4">
          ...
          <div class="site-tagline mb-3">
            ...
            developers. Built with Bootstrap 5 and Sass. Get started now!
          </div>
          <div class="cta-btns">
            <div class="mb-4">
              <a
            ...
            <ul
              class="app-stores list-unstyled list-inline mx-auto mx-md-0 d-inline-block"
            >
  ...
  <section class="benefits-section py-5">
    <div class="container py-lg-5">
      ...
      <div class="row">
        <div class="item col-12 col-lg-4">
          <div class="item-inner text-center p-3 p-lg-5">
            ...
            <h5>Focused on UX</h5>
            <div>
              Use this area to list your app's key benefits. Lorem ipsum dolor
      ...
      <div class="pt-3 text-center">
        <a
          class="btn btn-primary theme-btn theme-btn-ghost font-weight-bold"
          href="#"
          >Learn More</a
        >
      </div>
  ...
  <section class="features-section py-5">
    <div class="container py-lg-5 position-relative">
      <h3 class="mb-3 text-center font-weight-bold section-heading">
        Feature Highlights
      </h3>
      <div class="row pt-5 mb-5">
        <div class="col-12 col-md-6 col-xl-5 offset-xl-1 d-none d-md-block">
          <img
            class="product-figure product-figure-1 img-fluid"
        ...
        <div class="col-12 col-md-6 col-xl-5 pr-xl-3 pt-md-3">
          <div class="card rounded border-0 shadow-lg mb-5">
            <div class="card-body p-4">
              <h5 class="card-title">
                <i
                  class="far fa-chart-bar me-2 me-lg-3 text-primary fa-lg fa-fw"
                ></i
                >Feature Lorem Ipsum
              </h5>
              <p class="card-text">
                List one of your product's main features here. The screenshots
                used in this template are taken from Bootstrap admin template
                Appify.
              </p>
              <a class="more-link" href="#"
                >Learn more <span class="more-arrow">&rarr;</span></a
              >
            </div>
          </div>
          <!--//card-->
          ...
          <div class="card rounded border-0 shadow-lg mb-5">
            <div class="card-body p-4">
              <h5 class="card-title">
                <i
                  class="fas fa-laptop-code me-2 me-lg-3 text-primary fa-lg fa-fw"
                ></i
          ...
          <div class="card rounded border-0 shadow-lg">
            <div class="card-body p-4">
              <h5 class="card-title">
                <i
                  class="far fa-calendar-alt me-2 me-lg-3 text-primary fa-lg fa-fw"
                ></i
                >Feature Lorem Ipsum
              </h5>
              <p class="card-text">
      ...
      <div class="row">
        <div
          class="col-12 col-md-6 col-xl-5 order-md-2 pr-xl-3 d-none d-md-block"
        >
          <img
            class="product-figure product-figure-2 img-fluid"
        ...
        <div class="col-12 col-md-6 col-xl-5 order-md-1 offset-xl-1 pt-xl-5">
          <div class="card rounded border-0 shadow-lg mb-5">
            <div class="card-body p-4">
              <h5 class="card-title">
                <i
                  class="fas fa-microphone-alt me-2 me-lg-3 text-primary fa-lg fa-fw"
                ></i
                >Feature Commodo
              </h5>
              <p class="card-text">
                List one of your product's main features here. The screenshots
                used in this template are taken from Bootstrap admin template
                Appify. Donec quam felis, ultricies nec, pellentesque eu,
                pretium quis, sem.
              </p>
              <a class="more-link" href="#"
                >Learn more <span class="more-arrow">&rarr;</span></a
          ...
          <div class="card rounded border-0 shadow-lg">
            <div class="card-body p-4">
              <h5 class="card-title">
                <i
                  class="far fa-comments me-2 me-lg-3 text-primary fa-lg fa-fw"
                ></i
                >Feature Ligula Eget
              </h5>
              <p class="card-text">
                List one of your product's main features here. Lorem ipsum dolor
                sit amet. The screenshots used in this template are taken from
                Bootstrap admin template Appify.
              </p>
              <a class="more-link" href="#"
                >Learn more <span class="more-arrow">&rarr;</span></a
              >
  ...
  <section class="cta-section py-5 theme-bg-secondary text-center">
    <div class="container">
      ...
      <div class="text-white mx-auto single-col-max-width section-intro">
        Try Nova Free Today. Lorem ipsum dolor sit amet, consectetuer adipiscing
        elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque
        penatibus et magnis dis.
      </div>
      <a class="btn theme-btn theme-btn-ghost theme-btn-on-bg mt-4" href="#"
        >Download Now - It's FREE</a
      >
    </div>
  </section>
  <!--//cta-section-->
  ...
  <section id="quote" class="testimonial-section py-5">
    <div class="py-lg-5">
        ...
        <div class="carousel-cell">
          <div class="item-inner shadow rounded">
            ...
            <div class="mb-3">
              ...
              penatibus et magnis dis.Lorem ipsum dolor sit amet, consectetuer
              adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.
            </div>
            <div class="source row">
              <div class="col-auto">
                <img
                  class="source-profile rounded-circle"
        ...
        <div class="carousel-cell">
          <div class="item-inner shadow rounded">
            ...
            <div class="source row">
              <div class="col-auto">
                <img
                  class="source-profile rounded-circle me-3"
      ...
      <div class="pt-5 text-center">
        <a class="btn btn-primary theme-btn font-weight-bold" href="#"
          >Try Nova Now</a
        >
      </div>
    </div>
...
<style>
@import "assets/landing//plugins/flickity/flickity.min.css";
@import "assets/landing/css/theme.css";
</style>
